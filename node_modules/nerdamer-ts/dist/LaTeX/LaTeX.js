...
class LaTeX {
    ...
    static latex(symbol, option) {
        ...
        if (symbol instanceof Collection_1.Collection)
        ...
        if (Array.isArray(symbol)) {
            ...
            for (var i = 0; i < symbol.length; i++) {
                ...
                if (!(0, Utils_1.isSymbol)(sym))
                    sym = (0, Parser_1.parse)(sym);
        ...
        symbol = symbol.clone();
        var decimal = (option === 'decimal' || option === 'decimals'), power = symbol.power, invert = (0, Utils_1.isNegative)(power), negative = symbol.multiplier.lessThan(0);
        if (symbol.group === Groups_1.Groups.P && decimal) {
            ...
            else if ((0, Utils_1.isSymbol)(power))
    ...
    static value(symbol, inverted, option, negative) {
        ...
        if (symbol.isInfinity) {
            ...
            var collected = symbol.collectSymbols().sort(group === Groups_1.Groups.CP || previousGroup === Groups_1.Groups.CP ?
                function (a, b) {
            ...
            symbol.each(function (x) {
                var isDenom = (0, Utils_1.isNegative)(x.power), laTex;
                if (isDenom) {
