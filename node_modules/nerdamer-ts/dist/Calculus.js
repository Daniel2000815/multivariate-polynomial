    ...
    var __ = core.Calculus = {
        ...
        sum: function (fn, index, start, end) {
            ...
            if (core.Utils.isNumericSymbol(start) && core.Utils.isNumericSymbol(end)) {
                ...
                retval = core.Utils.block(modifier, function () {
                    var f = fn.text(), subs = { '~': true }, //lock subs. Is this even being used?
        ...
        product: function (fn, index, start, end) {
            ...
            if (core.Utils.isNumericSymbol(start) && core.Utils.isNumericSymbol(end)) {
                ...
                retval = core.Utils.block(modifier, function () {
                    ...
                    var f = fn.text(), subs = {}, retval = new core.Symbol(1);
                    for (var i = start; i <= end; i++) {
                        subs[index] = new Symbol(i);
        ...
        diff: function (symbol, wrt, nth) {
                ...
                if (g === N || g === S && symbol.value !== d || g === P) {
                    ...
                    switch (symbol.fname) {
                        ...
                        case 'erf':
                            ...
                            break;
                        case 'atan2':
                            var x_ = String(symbol.args[0]), y_ = String(symbol.args[1]);
            ...
            function product_rule(symbol) {
                ...
                var symbols = symbol.collectSymbols(), result = new Symbol(0), l = symbols.length;
        ...
        integration: {
            u_substitution: function (symbols, dx) {
                ...
                var a = symbols[0].clone(), b = symbols[1].clone(), g1 = a.group, g2 = b.group, 
                ...
                if (g1 === FN && g2 !== FN) {
                    ...
                    var f = function (a, b) {
                        var d = __.diff(b, dx);
                        var A = core.Algebra.Factor.factor(a), B = core.Algebra.Factor.factor(d);
                        var q = _.divide(A, B);
                        return q;
                    };
        ...
        integrate: function (original_symbol, dt, depth, opt) {
            ...
            return core.Utils.block('PARSE2NUMBER', function () {
                ...
                symbol = Symbol.unwrapSQRT(original_symbol.clone(), true), g = symbol.group, retval;
                try {
                    ...
                    //e.g. 2*x
                        ...
                        if (symbol.power.equals(1)) {
                            ...
                            var p = Number(symbol.power), m = symbol.multiplier.clone(); //temporarily remove the multiplier
                            symbol.toUnitMultiplier();
                            ...
                            b = decomp[3], ax = decomp[2], a = decomp[0], x = decomp[1];
                            ...
                            if (!a.contains(dx, true) && symbol.isLinear()) { //perform a deep search for safety
                                ...
                                if (fname === COS || fname === SIN) {
                                    ...
                                    if (p < 0) {
                                        ...
                                        var arg = symbol.args[0], rd = symbol.clone(), //cos^(n-1)
                                        ...
                                        if (g1 === FN && g2 === FN) {
                                                        ...
                                                        if (fn1 === SIN && sym1.power.add(sym2.power).equals(0)) {
                                                            ...
                                                            if (even(sym1.power) && fn2 === COS && sym2.power.lessThan(0)) {
                                                                ...
                                                                if (!p1_even || !p2_even) {
                                                                    ...
                                                                    var sign = u.fname === COS ? -1 : 1, n = r.power, 
                                                                    ...
                                                                    trans = _.parse('(1-' + u.fname + core.Utils.inBrackets(arg1) + '^2)^' + k), sym = _.expand(_.multiply(new Symbol(sign), _.multiply(u.clone(), trans)));
                                            ...
                                            if (sym1.power.equals(-1 / 2)) {
                                                ...
                                                if (x.group !== PL && x.isLinear()) {
                                                    var p = Number(sym2.power), du = '_u_', u = new Symbol(du), 
                                                    //pull the integral with the subsitution
                                                    U = _.expand(_.divide(_.pow(_.subtract(u.clone(), b.clone()), new Symbol(p)), u.clone())), scope = {};
